...
public class EnemyEndCard_R2P_3_1 : MonoBehaviour
{
    ...
    {
        Vector3[] vectorPath = new Vector3[EndCard_R2P_3_1.Ins.movePath.Length + 1];
        for (int i = 0; i < vectorPath.Length - 1; i++)
        {
            vectorPath[i] = EndCard_R2P_3_1.Ins.movePath[i].position;
        }
