...
public class EndCard_V4 : MonoBehaviour
{
    #region Singleton
    public static EndCard_V4 Ins;
    void Awake()
    {
        Ins = this;
    }
    ...
    public Enemy_EndCard_V4[] enemies_EndCard;

    private GameManager_V4 gameManager;

	void Start()
	{
        gameManager = GameManager_V4.Ins;
	}

    public void SetupEndCard()
	{
        foreach(Enemy_EndCard_V4 e in enemies_EndCard)
		{
