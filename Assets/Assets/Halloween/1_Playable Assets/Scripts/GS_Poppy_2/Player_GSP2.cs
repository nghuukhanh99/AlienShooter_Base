...
public class Player_GSP2 : MonoBehaviour
{
    #region Singleton
    public static Player_GSP2 Ins;
    void Awake()
    {
        Ins = this;
    }
    ...
    private GameManager_GSP2 gameManager;
    ...
    void Start()
    {
        ...
        gameManager = GameManager_GSP2.Ins;
