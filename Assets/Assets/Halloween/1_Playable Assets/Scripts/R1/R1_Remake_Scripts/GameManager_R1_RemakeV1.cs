...
public class GameManager_R1_RemakeV1 : MonoBehaviour
{
    #region Singleton
    public static GameManager_R1_RemakeV1 Ins;
    void Awake()
    {
        Ins = this;
    }
    ...
    private Enemy_R1_Remake_V1 enemyManager;
    ...
    void Start()
    {
        ...
        fighter = Player_R1_RM_V1.Ins;
        enemyManager = Enemy_R1_Remake_V1.Ins;
    ...
    private void FixedUpdate()
    {
        ...
        if (!isWin && Enemy_R1_Remake_V1.Ins.GetDiedEnemy() == Enemy_R1_Remake_V1.Ins.enemies_num)
        {
            isWin = true;
